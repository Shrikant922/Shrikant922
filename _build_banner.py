...
<!-- Cycling roles -->
<clipPath id="r1"><rect x="48" y="190" width="0" height="40"><animate attributeName="width" values="0;0;360;360;0;0" keyTimes="0;.01;.07;.2;.24;1" dur="24s" repeatCount="indefinite" begin="2.9s"/></rect></clipPath>
<clipPath id="r2"><rect x="48" y="190" width="0" height="40"><animate attributeName="width" values="0;0;360;360;0;0" keyTimes="0;.26;.32;.45;.49;1" dur="24s" repeatCount="indefinite" begin="2.9s"/></rect></clipPath>
<clipPath id="r3"><rect x="48" y="190" width="0" height="40"><animate attributeName="width" values="0;0;360;360;0;0" keyTimes="0;.51;.57;.7;.74;1" dur="24s" repeatCount="indefinite" begin="2.9s"/></rect></clipPath>
<clipPath id="r4"><rect x="48" y="190" width="0" height="40"><animate attributeName="width" values="0;0;360;360;0;0" keyTimes="0;.76;.82;.95;.99;1" dur="24s" repeatCount="indefinite" begin="2.9s"/></rect></clipPath>
...
<text class="st" x="246" y="616" text-anchor="middle" font-size="18" font-weight="bold" fill="#a855f7" filter="url(#glow)" style="animation:fadeIn .4s ease 6.95s forwards">500+</text>
<text class="st" x="378" y="616" text-anchor="middle" font-size="18" font-weight="bold" fill="#fde047" filter="url(#glow)" style="animation:fadeIn .4s ease 7.1s forwards">100+</text>
<text class="st" x="502" y="616" text-anchor="middle" font-size="18" font-weight="bold" fill="#c084fc" filter="url(#glow)" style="animation:fadeIn .4s ease 7.25s forwards">15+</text>
